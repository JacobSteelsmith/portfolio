...
transparent\_squid 8080 "root root"
interface any world
policy drop
protection strong
client all accept
...
----
g). Edit /etc/default/firehol and set START\_FIREHOL=YES. Run /etc/init.d/firehol restart to restart and run sudo get-iana (if it fails, ignore it)
